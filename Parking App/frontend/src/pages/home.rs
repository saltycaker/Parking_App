...
pub fn Home() -> impl IntoView {
    ...
    view! {
        <div class="relative min-h-screen">
                ...
                <div class="bg-white rounded-lg shadow-lg p-4">
                    <div class="flex items-center gap-3">
                        <input
                            ...
                            class="flex-1 outline-none text-black text-lg font-medium placeholder-gray-400"
                        ...
                        />
                        <button
                            class="bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition font-medium"
                            on:click=search
                        >
                            "Search"
                        </button>
            ...
            <button class="absolute bottom-32 right-4 z-10 bg-white rounded-lg shadow-lg p-3 hover:bg-gray-50 transition">
            ...
            <button class="absolute top-20 right-4 z-10 bg-white rounded-lg shadow-lg p-3 hover:bg-gray-50 transition">
                <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                </svg>
            </button>

            <!-- Results Bottom Sheet - Uber style -->
            <div class="absolute bottom-0 left-0 right-0 z-10 bg-white rounded-t-xl shadow-2xl max-h-[70vh] overflow-hidden">
                <div class="p-4">
                    ...
                    if loading.get() {
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-xl font-bold text-black">Nearby Parking</h2>
                            <A href="/profile" class="text-black font-semibold">Profile</A>
                        </div>
                        
                        <div class="space-y-2 overflow-y-auto max-h-[50vh]">
                            {results.get().into_iter().map(|result| {
                                view! {
                                    <div class="bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition cursor-pointer border border-gray-200">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1">
                                                <h3 class="font-semibold text-black">{result.location.name}</h3>
